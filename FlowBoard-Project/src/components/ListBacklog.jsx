...
import '../css/ListBacklog.css';



function ListBacklog({ cards, listId, setAllCards }) {
    ...
    const handleDelete = (id) => {
        deleteCardById(id, setAllCards); // setAllCards geçiriyoruz
    };
    ...
    return (
        <SectionCard title="Backlog" imageSrc="backlog.png">
