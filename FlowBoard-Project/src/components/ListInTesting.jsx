...
import '../css/ListInTesting.css';

function ListInTesting({ cards, listId, setAllCards }) {
    ...
    return (
        <SectionCard title="In Testing" imageSrc="intestiing.png">
